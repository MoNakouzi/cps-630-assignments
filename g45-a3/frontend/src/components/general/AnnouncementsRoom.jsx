...
export default function AnnouncementsRoom() {
        ...
        async function loadAnnouncements() {
            try {
                ...
                const res = await authFetch(
                    `${API_BASE_URL}/api/chat/announcements`,
                );
    ...
    return (
        <section className="max-w-4xl my-6 mx-auto rounded-xl border border-gray-200 bg-white shadow-sm">
            <div className="border-b border-gray-200 px-6 py-4">
                <h2 className="text-xl font-semibold">Announcements Room</h2>
                <p className="text-sm text-gray-600">
                    All logged in users are connected automatically. Regular
                    users can only receive announcements.
                </p>
            </div>
