                ...
                <ul className="space-y-3">
                    {navItems.map((item) => (
                        <li key={item.href}>
                            <Link
                                to={item.href}
                                className="block text-slate-700 font-medium px-2 py-2 rounded hover:bg-slate-50 transition-colors"
                                onClick={() => {
                                    if (onClose) onClose();
                                }}
                            >
                            ...
                            <div className="pt-2 border-t">
                                <div className="flex items-center gap-3 bg-violet-50 rounded-lg p-3">
                                    ...
                                    <div>
                                        <div className="flex items-center gap-2">
                                            ...
                                            <span className="text-xs inline-flex items-center rounded-full bg-slate-100 px-2 py-0.5 text-slate-700">
                                                {user.role === "admin"
                                                    ? "Admin account"
                                                    : "Regular account"}
                                            </span>
                                ...
                                <div className="mt-3 space-y-2">
                                    ...
                                    <button
                                        ...
                                        className="w-full text-left px-2 py-2 rounded text-red-600 hover:bg-slate-50 transition"
                                    >
                                        Logout
                                    </button>
                                </div>
